...
var testGHFilterDataEthusdt5m = []byte(`[
  {
    "open": 1591.11,
    "high": 1593.62,
    "low": 1589.04,
...
func Test_GHFilter(t *testing.T) {
	type args struct {
		allKLines []types.KLine
		window    int
	}
	var klines []types.KLine
	if err := json.Unmarshal(testGHFilterDataEthusdt5m, &klines); err != nil {
		panic(err)
	}
	tests := []struct {
		name string
...
func Test_GHFilterEstimationAccurate(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "ETHUSDT G-H Filter square error 7",
			args: args{
				allKLines: klines,
				window:    7,
			},
		...
		{
			name: "ETHUSDT G-H Filter square error 25",
			args: args{
				allKLines: klines,
				window:    25,
			},
		...
		{
			name: "ETHUSDT G-H Filter square error 99",
			args: args{
				allKLines: klines,
				window:    99,
			},
